...
document.addEventListener('DOMContentLoaded', async (e) => {
 ...
 const question = await poll_dapp_backend.getQuestion();
 ...
 const voteCounts = await poll_dapp_backend.getVotes();
...
pollForm.addEventListener('submit', async (e) => {
 ...
 const updatedVoteCounts = await poll_dapp_backend.vote(checkedValue);
...
resetButton.addEventListener('click', async (e) => {
   ...
   await poll_dapp_backend.resetVotes();
   const voteCounts = await poll_dapp_backend.getVotes();
   updateLocalVoteCounts(voteCounts);
...
class App {
  ...
  #handleSubmit = async (e) => {
    ...
    this.greeting = await poll_dapp_backend.greet(name);
    this.#render();
  };
